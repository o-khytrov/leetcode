...
#  
# 
#  Related Topics Tree Depth-First Search Binary Tree 👍 2524 👎 49

import unittest
from typing import Optional


class DeleteLeavesWithAGivenValue_Test(unittest.TestCase):

    def test_deleteLeavesWithAGivenValue(self):
        pass
...
class Solution:
    def removeLeafNodes(self, root: Optional[TreeNode], target: int) -> Optional[TreeNode]:
        def traverse(node: TreeNode, parent, side):
            if not node:
                return
