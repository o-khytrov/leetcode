...
#  
# 
#  Related Topics Array Two Pointers Greedy Sorting 👍 2624 👎 466

import unittest
from typing import List


class BagOfTokens_Test(unittest.TestCase):

    def test_bagOfTokens(self):
        test_data = [
            ([100], 50, 0),
            ([200, 100], 150, 1),
            ([100, 200, 300, 400], 200, 2)
        ]
        for tokens, power, expected in test_data:
            with self.subTest():
                self.assertEqual(expected, Solution().bagOfTokensScore(tokens, power))
