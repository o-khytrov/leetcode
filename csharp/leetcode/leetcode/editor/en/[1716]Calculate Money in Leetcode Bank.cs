...
namespace CalculateMoneyInLeetcodeBank
{
    public class Tests
    {
        ...
        [InlineData(10, 37)]
        [InlineData(20, 96)]
        public void CalculateMoneyInLeetcodeBankTest(int n, int expectedResult)
        {
            Assert.Equal(expectedResult, new Solution().TotalMoney(n));
        }
    }
