...
<strong>Explanation:</strong> Move the first 'a' in <span><code>words[1] to the front of words[2],
to make </code></span><span><code>words[1]</code></span> = "abc" and words[2] = "abc".
All the strings are now equal to "abc", so return <span><code>true</code></span>.
</pre>
...
<div><div>Related Topics</div><div><li>Hash Table</li><li>String</li><li>Counting</li></div></div><br><div><li>👍 418</li><li>👎 44</li></div>