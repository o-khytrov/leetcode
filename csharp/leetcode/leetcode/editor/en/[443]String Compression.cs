...
symbol.
 ...
 Related Topics Two Pointers String 👍 4544 👎 7270
...
namespace StringCompression
{
    ...
    {
        [Theory]
        [InlineData("[\"a\",\"a\",\"b\",\"b\",\"c\",\"c\",\"c\"]", "[\"a\",\"2\",\"b\",\"2\",\"c\",\"3\"]")]
        [InlineData("[\"a\"]", "[\"a\"]")]
        [InlineData("[\"a\",\"b\",\"b\",\"b\",\"b\",\"b\",\"b\",\"b\",\"b\",\"b\",\"b\",\"b\",\"b\"]",
            "[\"a\",\"b\",\"1\",\"2\"]")]
        public void StringCompressionTest(string charsJson, string expectedResultJson)
        {
            var chars = JsonSerializer.Deserialize<char[]>(charsJson)
                        ?? throw new ArgumentException("Invalid json");
            var length = new Solution().Compress(chars);

            Assert.Equal(expectedResultJson, JsonSerializer.Serialize(chars.Take(length).ToArray()));
        }
    }
