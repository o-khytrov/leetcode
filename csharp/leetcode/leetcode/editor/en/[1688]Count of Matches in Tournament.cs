...
tournament, and the rest gets paired. A total of (n - 1) / 2 matches are played, and (
...
Total number of matches = 7 + 3 + 2 + 1 = 13.
 ...
 Related Topics Math Simulation 👍 1286 👎 189
...
namespace CountOfMatchesInTournament
{
    public class Tests
    {
        ...
        [InlineData(7, 6)]
        [InlineData(14, 13)]
        public void CountOfMatchesInTournamentTest(int n, int expectedResult)
        {
            Assert.Equal(expectedResult, new Solution().NumberOfMatches(n));
        }
    }
