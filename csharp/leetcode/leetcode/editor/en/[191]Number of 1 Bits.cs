...
Follow up: If this function is called many times, how would you optimize it?
 ...
 Related Topics Divide and Conquer Bit Manipulation 👍 6062 👎 1248
...
namespace NumberOf1Bits
{
    public class Tests
    {
        ...
        [InlineData(1, 1)]
        [InlineData(2, 1)]
        public void NumberOf1BitsTest(uint n, int expectedResult)
        {
            Assert.Equal(expectedResult, new Solution().HammingWeight(n));
        }
    }
