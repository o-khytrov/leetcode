...
namespace StudentAttendanceRecordI
{
    ...
    {
        [Theory]
        [InlineData("PPALLP", true)]
        [InlineData("PPALLL", false)]
        public void StudentAttendanceRecordITest(string s, bool expectedResult)
        {
            Assert.Equal(expectedResult, new Solution().CheckRecord(s));
        }
    }
