...
called.
 ...
 Related Topics Array Hash Table Math Design Randomized 👍 8591 👎 526
...
namespace InsertDeleteGetRandomO1
{
    public class Tests
    {
        [Theory]
        [InlineData]
        public void InsertDeleteGetRandomO1Test()
        {
        }
    }
...
//leetcode submit region begin(Prohibit modification and deletion)
    public class RandomizedSet
    {
        ...
        {
            var result = !_hashSet.Contains(val);
            _hashSet.Add(val);
        ...
        {
            var ind = _random.Next(0, _hashSet.Count);
            return _hashSet.ElementAt(ind);
        }
    }
